...
model_name = "gathering_social_share"#"gathering_social_v1"#gathering_1"
...
def main():
    ...
    multiPGCen = CenAgents([Centralised_AC(8,state_dim,add_para(i),useLaw=True) for i in range(n_agents)],state_dim,agentParam)  # create PGagents as well as a social agent
